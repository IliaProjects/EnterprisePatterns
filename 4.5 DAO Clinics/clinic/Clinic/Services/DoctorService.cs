...
namespace Clinic.Services
{
    public class DoctorService
    {
        ...
        public IEnumerable<Doctor> getAllSpecialities()
        {
            return _doctorMapper.GetAll();
        }
        ...
        public IEnumerable<Doctor> getDoctorsBySpeciality(string specialityName)
        {
            return _specialitiesMapper.Find("name", specialityName).FirstOrDefault().Doctors;
        }
